...
/**
 * Strings for component 'moodle', language 'zh_cn', branch 'MOODLE_25_STABLE'
 *
 * @package   moodle
...
$string['changesmadereallygoaway'] = '您做出了改动。您确定要离开并丢弃所有改动吗？';
...
$string['duplicate'] = '复制';
$string['duplicateconfirm'] = '您确定要复制{$a->modtype}“{$a->modname}”？';
$string['duplicatecontcourse'] = '返回课程';
$string['duplicatecontedit'] = '修改新拷贝';
$string['duplicatesuccess'] = '{$a->modtype}“{$a->modname}”已被成功复制';
...
$string['force'] = '强制';
$string['forcedmodeinbrackets'] = '{$a}(强制模式)';
...
$string['notifyloginfailuresmessageend'] = '您可以在 {$a}/report/log/index.php?id=1&chooselog=1&modid=site_errors 查看日志。';
